...
public enum Lang {
    ...
    HELP_EDIT("help-edit", "Edit general settings of a server-tutorial."),
    HELP_EDITPOINT("help-editpoint", "Edit a server-tutorial point."),
    HELP_EDITALL("help-editall", "Edit all server-tutorial point of a tutorial."),
